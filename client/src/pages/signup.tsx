...
export default function Signup(){
    return <div className="font-[sans-serif]  max-w-4xl flex items-center mx-auto md:h-screen p-4">
    <div className="grid md:grid-cols-3 items-center  rounded-xl overflow-hidden">
      ...
      <form className="md:col-span-2 w-full bg-white py-6 px-6 sm:px-16 ">
        <div className="mb-6">
